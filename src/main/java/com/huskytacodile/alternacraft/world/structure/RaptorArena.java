...
public class RaptorArena extends StructureFeature<JigsawConfiguration> {
    ...
    public RaptorArena() {
        ...
        super(CODEC, RaptorArena::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!RaptorArena.isFeatureChunk(context)) {
