...
public class RaptorDen extends StructureFeature<JigsawConfiguration> {
    ...
    public RaptorDen() {
        ...
        super(CODEC, RaptorDen::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!RaptorDen.isFeatureChunk(context)) {
