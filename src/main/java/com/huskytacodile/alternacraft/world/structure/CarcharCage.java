...
public class CarcharCage extends StructureFeature<JigsawConfiguration> {
    ...
    public CarcharCage() {
        ...
        super(CODEC, CarcharCage::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!CarcharCage.isFeatureChunk(context)) {
