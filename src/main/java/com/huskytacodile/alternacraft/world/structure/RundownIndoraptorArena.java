...
public class RundownIndoraptorArena extends StructureFeature<JigsawConfiguration> {
    ...
    public RundownIndoraptorArena() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, RundownIndoraptorArena::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!RundownIndoraptorArena.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            Alternacraft.LOGGER.log(Level.DEBUG, "Rundown House at {}", blockpos);
        }
