...
public class CarnotaurusPaddock extends StructureFeature<JigsawConfiguration> {
    ...
    public CarnotaurusPaddock() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, CarnotaurusPaddock::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!CarnotaurusPaddock.isFeatureChunk(context)) {
